        ...
        while True:
            ...
            if hand_infos:
                ...
                if g == "PINCH":
                    ...
                    # ALT+TAB mode: two fingers, thumb OFF, LEFT/RIGHT only
                    if g == "TWO_FINGERS" and not thumb_on and direction in ("LEFT", "RIGHT"):
                        desired_mode = "ALT_TAB"
                        desired_alt_tab_dir = direction

                    # SCROLL mode: two fingers, thumb OFF, UP/DOWN
                    elif g == "TWO_FINGERS" and not thumb_on and direction in ("UP", "DOWN"):
            ...
            cv2.imshow("Gesture OS Controller - Scroll/AltTab+Mouse", frame)
